# test_new_structure.py (versión corregida al final)
...
def test_services():
    ...
    try:
        ...
        with app.app_context():
            ...
            # Probar FilterService (con límite pequeño para evitar demoras)
...
def test_endpoints():
    ...
    try:
        ...
        with app.test_client() as client:
            ...
            # Probar /api/search con un término simple
            response = client.post('/api/search', 
                json={'query': 'construcción', 'search_type': 'titulo'})
            ...
            if response.status_code == 200:
                ...
                print(f"   ⚠️ POST /api/search respondió con código: {response.status_code}")
